...
var today = new Date();
document.getElementById("date_difference_details").innerHTML =findDiff("Dec 30, 2021",today)
document.getElementById("date_difference_small").innerHTML =findDiff("Dec 30, 2021",today)
/**
